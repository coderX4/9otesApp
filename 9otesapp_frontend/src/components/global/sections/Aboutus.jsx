        ...
        <section className="py-20 px-6 bg-white">
            <div className="max-w-7xl mx-auto text-center">
                ...
                <p className="text-lg text-gray-600 max-w-4xl mx-auto mb-12">
                    9otes is dedicated to providing high-quality study materials and an interactive learning
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div
                            key={index}
                            className="bg-indigo-100 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105"
                        >
