...
export default function Sidebar() {
    ...
    return (
        <aside
            className="w-64 bg-white bg-opacity-50 backdrop-blur-lg border-r border-indigo-200 shadow-lg rounded-r-2xl p-4 flex flex-col h-full">
            <div className="mb-6">
                ...
                <Link to={`/dashboard/importSubject`}>
                    <button
                        className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white shadow-md p-2 rounded-lg flex items-center justify-center w-full">
